...
public partial class URL(string address, int port)
{
	public string address = address;
	public int port = port;
}

public partial class PlatformCoreConfig
{
	public CoreConfig? windows, linux;
}

public partial class CoreConfig(int port, CoreConfig.CoreMode mode, CoreConfig.DuelConfig? duel_config = null, CoreConfig.DeckConfig? deck_config = null)
{
	...
	public partial class DuelConfig(PlayerConfig[] players, bool noshuffle)
	{
		public PlayerConfig[] players = players;
		public bool noshuffle = noshuffle;
	}
	public partial class PlayerConfig(string name, string[] decklist, string id)
	{
		public string name = name;
		public string[] decklist = decklist;
		public string id = id;
	}
	public partial class DeckConfig(URL additional_cards_url, string deck_location, bool should_fetch_additional_cards)
	{
...
public partial class PlatformClientConfig
{
...
public partial struct CoreInfo
{
...
public partial class ServerConfig(string additional_cards_path, string? artwork_path, int port, int room_min_port, int room_max_port, CoreInfo core_info)
{
	public CoreInfo core_info = core_info;
	public int port = port;
