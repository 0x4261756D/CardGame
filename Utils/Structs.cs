...
// 		Location location, int position,
...
// 		}
// 		else if(location == Location.Ability)
// 		{
...
// 		public class GetOptionsRequest(Location location, int uid) : Packet
// 		{
// 			public Location location = location;
// 			public int uid = uid;
// 		}
// 		public class GetOptionsResponse(Location location, int uid, CardAction[] options) : Packet
// 		{
// 			public Location location = location;
// 			public int uid = uid;
...
// 		public class SelectOptionRequest(Location location, int uid, CardAction cardAction) : Packet
// 		{
// 			public Location location = location;
// 			public int uid = uid;
