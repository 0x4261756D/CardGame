...
class Program
{
	...
	static void Main(string[] args)
	{
		...
		PlatformServerConfig platformConfig = JsonSerializer.Deserialize(File.ReadAllText(configLocation), PlatformServerConfigSerializationContext.Default.PlatformServerConfig);
