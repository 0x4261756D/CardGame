...
class Empower : Spell
{
	...
	public void CastEffect()
	{
		...
		RegisterStateReachedTrigger(trigger: new StateReachedTrigger(effect: () => target.Keywords.Remove(Keyword.Mighty), state: GameConstants.GameState.TurnEnd, influenceLocation: Location.Any, oneshot: true), referrer: this);
	}
