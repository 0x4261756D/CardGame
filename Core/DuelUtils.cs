...
{
	public Location influenceLocation;
	public GameConstants.GameState state;
	public TriggerCondition condition;
	public Effect effect;
	public bool oneshot, wasTriggered;

	public StateReachedTrigger(Effect effect, TriggerCondition condition, GameConstants.GameState state, Location influenceLocation = Location.Field, bool oneshot = false)
	{
		this.influenceLocation = influenceLocation;
		this.state = state;
	...
	public StateReachedTrigger(Effect effect, GameConstants.GameState state, Location influenceLocation = Location.Field, bool oneshot = false)
	{
		this.influenceLocation = influenceLocation;
		this.state = state;
		this.oneshot = oneshot;
...
public delegate void RegisterStateTemporaryLingeringEffectDelegate(LingeringEffectInfo info, GameConstants.GameState state);
